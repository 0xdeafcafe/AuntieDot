...
{
	public class CampaignResponse : XResponse
	{
		public Summary Summary { get; set; }
		public int TotalGamesCompleted { get; set; }
		public int TotalMapsBeatSinglePlayer { get; set; }
		public int TotalMapsBeatCoop { get; set; }
		public int TotalMapsBeatSinglePlayerNoDeaths { get; set; }
		public int TotalMapsBeatCoopNoDeaths { get; set; }
		public int TotalMissionsCompleted { get; set; }
		public IList<TerminalVisited> TerminalsVisited { get; set; }
		public IList<Map> Maps { get; set; }
		public int DateFidelity { get; set; }
		public string ArticleId { get; set; }
		public int TotalChallengesCompleted { get; set; }
		public object TotalMedalsStats { get; set; }
		public object TopMedalIds { get; set; }
		...
		public object BestGameMedalsByTier { get; set; }
		...
		public string BestDayDuration { get; set; }
		...
		public object BestDayMedalsByClass { get; set; }
		public object BestDayMedalsByTier { get; set; }
